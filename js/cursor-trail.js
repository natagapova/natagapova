...
const CURSOR_TRAIL_BASE_SPEED = 0.4;
const CURSOR_TRAIL_SPEED_STEP = 0.02;
const CURSOR_TRAIL_MIN_SPEED = 0.22;
  ...
  const tick = () => {
    ...
    for (const dot of dots) {
      const speed = Math.max(
        CURSOR_TRAIL_MIN_SPEED,
        CURSOR_TRAIL_BASE_SPEED - dot.index * CURSOR_TRAIL_SPEED_STEP
      );
